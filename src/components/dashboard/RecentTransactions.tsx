    ...
    return (
        <div className="w-[914px] px-6 py-4 bg-white rounded-2xl inline-flex flex-col justify-start items-start gap-8 overflow-hidden">
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
                ...
                <div className="self-stretch flex flex-col justify-start items-start gap-6">
                    <div className="self-stretch h-12 inline-flex justify-between items-start">
                        <div className="w-[1015px] flex justify-start items-start gap-6">
                            <div className="w-12 h-12 p-2.5 bg-neutral-400 rounded-[47px] inline-flex flex-col justify-center items-center gap-2.5 overflow-hidden">
                    ...
                    <div className="self-stretch h-12 inline-flex justify-between items-center">
                        <div className="w-[1019px] flex justify-start items-start gap-6">
                            <div className="w-12 h-12 p-2.5 bg-neutral-400 rounded-[47px] inline-flex flex-col justify-center items-center gap-2.5 overflow-hidden">
                                <img src={cadie} alt="Transaction" className="w-6 h-6" />
                            </div>
                            <div className="flex-1 inline-flex flex-col justify-start items-start gap-2">
                    ...
                    <div className="self-stretch h-12 inline-flex justify-between items-start">
                        <div className="w-[1020px] flex justify-start items-start gap-6">
                            <div className="w-12 h-12 p-2.5 bg-neutral-400 rounded-[47px] inline-flex flex-col justify-center items-center gap-2.5 overflow-hidden">
                                <img src={cadie} alt="Transaction" className="w-6 h-6" />
                            </div>
                            <div className="flex-1 inline-flex flex-col justify-start items-start gap-2">
                                <div className="self-stretch h-5 justify-start text-emerald-950 text-lg font-normal font-['Inter'] leading-7">Amazon</div>
                                <div className="self-stretch h-4 justify-start text-neutral-400 text-base font-normal font-['Inter'] leading-6">Paiement par carte</div>
                            </div>
                        </div>
                        <div className="justify-start text-orange-400 text-xl font-normal font-['Inter'] leading-9">-2,99 €</div>
                    </div>
                </div>
            </div>
        </div>
