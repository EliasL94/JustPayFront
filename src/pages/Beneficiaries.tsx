...
const Beneficiaries = () => {
    ...
    return (
        <div className="w-full h-full inline-flex justify-start items-start gap-6 bg-slate-50 min-h-screen">
            <div className="flex-1 self-stretch px-4 md:px-6 py-12 inline-flex flex-col justify-start items-start gap-12">
                <BeneficiariesHeader />
                <div className="self-stretch flex-1 inline-flex justify-start items-start gap-6">
                    <div className="w-full max-w-full md:max-w-[925px] rounded-2xl inline-flex flex-col justify-start items-start gap-4">
