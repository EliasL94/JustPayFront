...
const CloseAccountModal = ({ onClose, onConfirm }: CloseAccountModalProps) => {
    return (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
            <div className="w-[634px] p-6 bg-white rounded-2xl inline-flex flex-col justify-start items-start gap-6 overflow-hidden shadow-xl">
                ...
                <div className="inline-flex justify-start items-start gap-2.5">
                    ...
                    <div onClick={onConfirm} data-icon-left="false" data-icon-right="false" data-label="true" data-size="Large" data-style="Solid" className="px-6 py-4 bg-orange-400 rounded-md flex justify-center items-center gap-2 overflow-hidden cursor-pointer hover:bg-orange-500 transition-colors">
